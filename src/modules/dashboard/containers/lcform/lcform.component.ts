...
import { LcOfficeComponent } from './forms-pages';
import { ChargeDetailComponent } from './forms-pages/charge-detail/charge-detail.component';
import { LcApplicantDetailComponent } from './forms-pages/lc-applicant-detail/lc-applicant-detail.component';
import { LcBeneficiaryDetailComponent } from './forms-pages/lc-beneficiary-detail/lc-beneficiary-detail.component';
import { LcShipmentDetailComponent } from './forms-pages/lc-shipment-detail/lc-shipment-detail.component';
import { PolicyComponent } from './forms-pages/policy/policy.component';


@Component({
  selector: 'sb-lcform',
  changeDetection: ChangeDetectionStrategy.OnPush,
  templateUrl: './lcform.component.html',
  styleUrls: ['lcform.component.scss'],
})
export class LcFormComponent implements OnInit, AfterViewInit {
  @ViewChild("content", { static: false }) content: any;
  @ViewChild('stepper1', { static: false }) stepper1: any;
  @ViewChild('shipment', { static: false }) shipment!: LcShipmentDetailComponent;
  @ViewChild('charge', { static: false }) charge!: ChargeDetailComponent;
  @ViewChild('policy', { static: false }) policy!: PolicyComponent;
  @ViewChild('beneficiary', { static: false }) beneficiary!: LcBeneficiaryDetailComponent;
  @ViewChild('applicant', { static: false }) applicant!: LcApplicantDetailComponent;
  @ViewChild('office', { static: false }) office!: LcOfficeComponent;
