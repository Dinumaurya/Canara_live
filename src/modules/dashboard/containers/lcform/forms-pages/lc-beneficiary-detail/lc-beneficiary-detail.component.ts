...
@Component({
  selector: 'sb-lc-beneficiary-detail',
  templateUrl: './lc-beneficiary-detail.component.html',
  styleUrls: ['./lc-beneficiary-detail.component.scss']
})
export class LcBeneficiaryDetailComponent implements OnInit, AfterViewInit {
  amount: any;
