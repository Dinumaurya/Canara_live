...
@Component({
  selector: 'sb-import-bill-office',
  templateUrl: './import-bill-office.component.html',
  styleUrls: ['./import-bill-office.component.scss']
})
export class ImportBillOfficeComponent implements OnInit {
  public billOfficeform: FormGroup;
  public submittedillofficeForm6: boolean = false;
  public misRbiPurposeList: any;
  ...
  getOutwardMandatoryDoc() {
    this.comservice.getExportBillsDoc1().subscribe(data => {
      setTimeout(() => {
