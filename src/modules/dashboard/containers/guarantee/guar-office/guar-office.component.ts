...
@Component({
  selector: 'sb-guar-office',
  templateUrl: './guar-office.component.html',
  styleUrls: ['./guar-office.component.scss']
})
export class GuarOfficeComponent implements OnInit {
  ...
  constructor(
    ...
    this.officeform = this.formBuilder.group({
      ...
      officeUseVo: this.formBuilder.group({
        ...
        //   isDclrtnChckd:new FormControl('', [Validators.required]),
        // }),
        attchList: this.formBuilder.group({
          // attchList:new FormControl('', [Validators.required]),
          attchCd: new FormControl('', []),
