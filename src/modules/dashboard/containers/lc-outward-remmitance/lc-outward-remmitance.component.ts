...
@Component({
    selector: 'sb-lc-outward-remmitance',
    templateUrl: './lc-outward-remmitance.component.html',
    styleUrls: ['./lc-outward-remmitance.component.scss']
})
export class LcOutwardRemmitanceComponent implements OnInit {
