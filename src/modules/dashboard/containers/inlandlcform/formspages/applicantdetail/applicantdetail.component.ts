...
@Component({
    selector: 'sb-applicantdetail',
    templateUrl: './applicantdetail.component.html',
    styleUrls: ['./applicantdetail.component.scss'],
})
export class ApplicantdetailComponent implements OnInit {
    amount: string;
    lcappUserDetails: FormGroup;
    submittedlcForm1 = false;
    @Input() country = [];
    @Input() currency = [];
        ...
        this.lcappUserDetails = this.formBuilder.group({
            ...
            lcTransBnk: this.formBuilder.group({
                swiftCode: new FormControl('', [
                    Validators.required,
                    Validators.pattern(this.fh.IFSC_CODE),
                ]),
    ...
    if (data && data.body && data.body && data.body.CustomerInfoResponse)
    {
        ...
        this.lcappUserDetails.patchValue({
          lcCustDtls: {
            ...
            custNm:Cust,
                              /*   custNm:
                                    typeof rcData.CustomerFullName !== 'object'
                                        ? rcData.CustomerFullName
                                        : '', */
                                mobNo: typeof rcData.Phone !== 'object' ? rcData.Phone : '',
                                eMail: typeof rcData.EmailId !== 'object' ? rcData.EmailId : '',
                                address1:
                                    typeof rcData.Address1 !== 'object' ? rcData.Address1 : '',
                                address2:
                                    typeof rcData.Address2 !== 'object' ? rcData.Address2 : '',
                                address3:
                                    typeof rcData.Address3 !== 'object' ? rcData.Address3 : '',
