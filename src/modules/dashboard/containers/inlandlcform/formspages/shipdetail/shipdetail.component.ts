...
@Component({
    selector: 'sb-shipdetail',
    templateUrl: './shipdetail.component.html',
    styleUrls: ['./shipdetail.component.scss'],
})
export class ShipdetailComponent implements AfterViewInit {
    ...
    public enablee = false;
    public submittedlcFormship = false;
    ...
    ngAfterViewInit() {
        this.comservice.getIncoterms().subscribe(
            data => {
                    ...
                    this.incotermsList = [
                        {
                            ...
                            value: 'EXW',
                            crUser: 'BackEnd',
                            crDate: '2018-08-13T08:36:41.099+0000',
                            mdUser: null,
                            mdDate: null,
                            srNo: 8,
                        },
                        ...
                        },
                        {
                            ...
                            value: 'CIP',
                            crUser: 'BackEnd',
                            crDate: '2018-08-15T08:36:41.099+0000',
                            mdUser: null,
                            mdDate: null,
                            srNo: 3,
                        },
                        {
                            ...
                            value: 'FAS',
                            crUser: 'BackEnd',
                            crDate: '2018-08-19T08:36:41.099+0000',
                            mdUser: null,
                            mdDate: null,
                            srNo: 9,
                        },
                        {
                            ...
                            value: 'FCA',
                            crUser: 'BackEnd',
                            crDate: '2018-08-20T08:36:41.099+0000',
                            mdUser: null,
                            mdDate: null,
                            srNo: 10,
                        },
                        {
                            ...
                            value: 'DDP',
                            crUser: 'BackEnd',
                            crDate: '2018-08-23T08:36:41.099+0000',
                            mdUser: null,
                            mdDate: null,
                            srNo: 6,
                        },
        ...
        if (val.lCShipDtlsVo.hsCode !== '') {
            this.comservice.hsCodeDescription(val.lCShipDtlsVo.hsCode).subscribe(data => {
                if (data && data != null){
                    ...
                    this.modal_body_2 =
                        'H.S. Code is invalid kindly refer the "View H.S. Code" link next to description';
